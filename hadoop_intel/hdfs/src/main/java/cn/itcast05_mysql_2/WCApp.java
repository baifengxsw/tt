...
public class WCApp {
    public static void main(String[] args) throws Exception {
        ...
        String URL="jdbc:mysql://localhost:3306/big4?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false";
        String USER= "root";
        String PASS="123321";
        ...
        DBOutputFormat.setOutput(job,"stat","word","count");
