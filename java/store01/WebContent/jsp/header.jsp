...
<!--
	...
	<script >
		$(function(){
			<!-- 向服务端发起CategoryServlet_gteAllCats faqiajax请求 ，获取所有分类   -->
			var url ="/store01/CategoryServlet";
			var obj = {"method":"findAllCats"};
			$.post(url,obj,function(data){
				
				$.each(data,function(i,obj){
				var li = "<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findByCid&cid="+obj.cid+"'>"+obj.cname+"</a></li>";
					$("#myUL").append(li);
				});
			},"json");
