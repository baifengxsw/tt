		...
		<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
			...
			<div style="overflow: hidden;">
				...
				<% 
					...
					<li style="width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src=
					"products/1/cs1000<%=id %>.jpg" width="130px" height="130px" /></li>
			...
			<h2><a href="ClearHistory">清除浏览页面</a></h2>
		</div>
