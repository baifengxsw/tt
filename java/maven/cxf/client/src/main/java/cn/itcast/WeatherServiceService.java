 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://itcast.cn/", wsdlLocation = "http://localhost:8080/cxf/ws/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://itcast.cn/", "WeatherServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/cxf/ws/weatherService?wsdl");
    ...
    public IweatherService getWeatherServicePort() {
        return super.getPort(new QName("http://itcast.cn/", "WeatherServicePort"), IweatherService.class);
    }
    ...
    public IweatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://itcast.cn/", "WeatherServicePort"), IweatherService.class, features);
    }
